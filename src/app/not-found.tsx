    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      <div className="text-center max-w-md px-6">
        <div className="row flex justify-center mb-6 space-x-4">
          <svg id="zero" width="100" height="100" viewBox="0 0 100 100" fill="none" className="text-primary">
          ...
          <svg id="handboy" width="100" height="100" viewBox="0 0 100 100" fill="none" className="text-secondary">
            <rect x="30" y="30" width="40" height="40" stroke="currentColor" strokeWidth="5" />
          </svg>
          <svg id="girllight" width="100" height="100" viewBox="0 0 100 100" fill="none" className="text-tertiary">
            <polygon points="50,15 80,85 20,85" stroke="currentColor" strokeWidth="5" fill="none" />
          </svg>
          <svg id="hairgirl" width="100" height="100" viewBox="0 0 100 100" fill="none" className="text-quaternary">
